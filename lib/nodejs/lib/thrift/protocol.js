 ...
 * @property {number}  CT_STRING        - Array of bytes for strings.
 ...
 * @property {number}  CT_BINARY        - Array of bytes.
 */
...
TCompactProtocol.TTypeToCType = [
  ...
  TCompactProtocol.Types.CT_STRING,       // T_STRING
  ...
  0,                                      // unused
  0,                                      // unused
  TCompactProtocol.Types.CT_BINARY,       // T_BINARY
];
...
TCompactProtocol.prototype.getTType = function(type) {
  switch (type) {
    ...
    case TCompactProtocol.Types.CT_DOUBLE:
      return Type.DOUBLE;
    case TCompactProtocol.Types.CT_STRING:
      return Type.STRING;
...
TJSONProtocol.Type[Thrift.Type.BINARY] = '"bin"';
...
TJSONProtocol.RType.bin = Thrift.Type.BINARY;
